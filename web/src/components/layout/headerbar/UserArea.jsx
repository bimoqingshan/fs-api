      ...
      <div className='relative' ref={dropdownRef}>
        <Dropdown
          ...
          render={
            <Dropdown.Menu className='!bg-semi-color-bg-overlay !border-semi-color-border !shadow-lg !rounded-lg'>
              ...
              <Dropdown.Item
                onClick={logout}
                className='!px-3 !py-1.5 !text-sm !text-semi-color-text-0 hover:!bg-semi-color-fill-1 hover:!text-red-500'
              >
                <div className='flex items-center gap-2'>
                  <IconExit
                    size='small'
        ...
        >
          <Button
            theme='borderless'
            type='tertiary'
            className='flex items-center gap-1.5 !p-1 !rounded-full hover:!bg-semi-color-fill-1'
          >
            <Avatar
              size='extra-small'
